...
echo_and_run cd "/home/capstone/opencv/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/capstone/opencv/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/capstone/opencv/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
