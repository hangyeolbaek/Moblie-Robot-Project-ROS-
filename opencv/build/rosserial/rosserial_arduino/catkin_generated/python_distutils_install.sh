...
echo_and_run cd "/home/capstone/opencv/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/capstone/opencv/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/capstone/opencv/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
