...
echo_and_run cd "/home/capstone/opencv/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/capstone/opencv/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/capstone/opencv/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
